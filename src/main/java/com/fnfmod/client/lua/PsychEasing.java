...
/** Psych/Flixel-style tween easing curves used by Lua APIs. */
final class PsychEasing {
    ...
    private static double sine(double t, Direction direction) {
    ...
    private static double power(double t, Direction direction, int exponent) {
        return switch (direction) {
            case IN -> Math.pow(t, exponent);
            case OUT -> 1 - Math.pow(1 - t, exponent);
            case IN_OUT -> t < 0.5
    ...
    private static double circ(double t, Direction direction) {
        return switch (direction) {
    ...
    private static double expo(double t, Direction direction) {
        if (t == 0 || t == 1) return t;
        return switch (direction) {
    ...
    private static double back(double t, Direction direction) {
        double c1 = 1.70158;
        double c3 = c1 + 1;
        return switch (direction) {
    ...
    private static double elastic(double t, Direction direction) {
        if (t == 0 || t == 1) return t;
    ...
    private static double bounce(double t, Direction direction) {
        return switch (direction) {
